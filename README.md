# **Как привязать локальный репозиторий к удаленному** <br><br>
---
<br><br>
...
1. git init - инициализация папки проекта <br><br>

2. touch file name - создание файла <br><br>

3. git status - статус файлов проекта <br><br>

4. git add --all или (add .) - добавление файлов в репозиторий <br><br>

5. git commit -m 'Название коммита(осмысленное)' <br><br>

6. git log - история коммитов <br><br>


## Генерация SSH Key: <br><br>
...
7. git remote add origin git@github.com:YourRepositoryName/GitTrain.git <br>
 привязываем удаленный репоз к локальному (из каталога локального реппозитроия) <br><br>

8. git remote -v - проверяем связь <br><br>

9. git push -u origin master - добавляем в ветку master (-u используется только первый раз) <br><br>
...
## Работа с файлами и папками <br><br>
